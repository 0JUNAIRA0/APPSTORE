      ...
      <section className="w-full flex flex-col items-center text-center bg-[#f5f5f5] ">
        ...
        <div className="max-w-4xl mt-12">
          ...
          <p className="mt-4 text-gray-600 text-sm md:text-base px-3">
            At <span className="font-semibold">HERO.IO</span>, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting. Our goal is to turn your ideas into digital experiences that truly make an impact.
          </p>
